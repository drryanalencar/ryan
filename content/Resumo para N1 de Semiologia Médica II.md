...
- Zona 1: Geralmente não requer intervenção.
...
- "A palpação do pescoço deve sempre ser bimanual."

- A fratura vertebral osteoporótica e sintomática em apenas 1/3 dos casos e ocorrem frequentemente sem qualquer evidência traumática

- A modificação dérmica relacionada ao envelhecimento normal:
	- Flacidez da pele
	- Cutis romboidal
	- Melanose senil
	- Canicie
...
- Critérios maiores 
	- Déficit cognitivo de grau médio a avançado
	- Contraturas múltiplas: referem-se à presença de várias articulações com mobilidade reduzida ou ausente devido ao encurtamento ou rigidez dos tecidos.
- Critérios menores
	- Úlceras por pressão
	- Disfagia
	- Afasia: A afasia é uma condição neurológica que dificulta a comunicação, podendo ser parcial ou total.
	- Dupla incontinência (urinária e fecal)
###### Síndrome da incontinência urinária
- Perda involuntária de urina, que pode ser classificada em diferentes tipos, como incontinência de esforço, de urgência, mista, entre outras.
###### Quedas e instabilidade postural 
- Ocorrência de quedas frequentes ou dificuldade em manter o equilíbrio, aumentando o risco de fraturas e outras complicações.
###### Síndrome da fragilidade
- **Critérios Comuns** (Fried et al.):
	- Perda de peso não intencional.
	- Fadiga ou exaustão.
	- Fraqueza (diminuição da força de preensão manual).
	- Marcha lenta.
	- Baixo nível de atividade física.
###### Delirium
-  Estado confusional agudo, com início abrupto e curso flutuante, caracterizado por distúrbios na atenção, consciência e cognição.
###### Demências
...
# 🧠 Psiquiatria
###### Conceitos
- Perguntava qual problema de fala que fazia a pessoa falar mto > Logorreia
- Dava um conceito e pergunta do que era > Humor
- Ato compulsivo: você não controla o que está fazendo, mas tem consciência, ou pelo menos tenta parar. Comportamento repetitivo e estereotipado, realizado para **reduzir ansiedade** ou prevenir um evento temido.
- Ato impulsivo: você não controla o que está fazendo e não tem consciência que está fazendo por impulsividade. Ação súbita e impensada, feita sem planejamento, sem preocupação com as consequências. Pessoa com **Transtorno de Personalidade Borderline** que agride alguém ou faz compras excessivas sem pensar nas consequências.
...
- O exame mini mental avalia funções cognitivas superiores.
- Sinal de Lesague positivo pode ser indicativo de lesão da coluna lombar.
- No paciente com Hanseníase podemos encontrar espessamento dos nervos radial e ulnar.
- A atrofia cortical senil pode levar ao aparecimento de manchas de pequenos passos
###### Escala de coma de Glasgow
- Dava um caso lá e os indicativos de Glasgow e pedia pra calcular (não respondia o ocular, nem verbal, nem motor) > 3 pontos
###### Lesões 
**Lesão no primeiro neurônio x segundo neurônio**
1. **Trato corticoespinhal (lesão do neurônio motor superior - NMS)** ou
	1. Córtex motor, cápsula interna, tronco encefálico ou trato corticoespinhal na medula.
	2. **Sinal de Babinski positivo** – Reflexo plantar extensor (dorsiflexão do hálux ao estimular a planta do pé).
	3. **Exemplos de doenças:**
		1. AVC (acidente vascular cerebral)
		2. Esclerose múltipla
		3. Lesão medular alta
		4. Paralisia cerebral
2. **Neurônio motor inferior (NMI) na medula e nervos periféricos**.
	1. Corno anterior da medula, nervo periférico, raiz nervosa ou junção neuromuscular.
	2. Sem estímulo neural, o músculo perde sua função e atrofia rapidamente.
	3. Exemplos de doenças:
		1. Poliomielite
		2. Esclerose lateral amiotrófica (ELA - fase inicial apenas NMI, depois NMS)
		3. Síndrome de Guillain-Barré
		4. Radiculopatias
- ⁠Paciente com Babinski positivo, lesão aonde > Em tese é Piramidal, mas a opção era motor cortico-espinhal (que também é piramidal).
	- **Lesão no trato corticoespinhal (trato piramidal)**
	- https://youtu.be/fsdTg8ckqqg?si=OB9YHIi8o_xQkSQG
- ⁠Paciente com anisocoria e midríase em olho direito, lesão aonde? > Nervo oculomotor direito.
- ⁠Pedia os nervos relacionados a 2/3 gustativo anterior, 1/3 gustativo posterior e motor da língua > 7/9/12
###### Síndrome do 1º neurônio motor
- Envolve sinais de lesão de vias corticoespinhais (vias piramidais), como:
	- Hiperreflexia,
	- Espasticidade,
	- Sinal de Babinski (extensor),
	- Fraqueza ou paralisia em determinados grupos musculares.
###### Síndrome Neuroléptica Maligna (SNM)
- Associada ao uso de antipsicóticos (como o haloperidol)
- **Hipertonia muscular (“rigidez em tubo de chumbo”)**:
- **Hipertermia**:
...
- Febre pode ocorrer, dependendo da etiologia.
###### Cefaleia
- Varias causas: 
	- Vascular, tensional.
###### TONTURA E VERTIGEM
- Tontura = instabilidade do equilíbrio e marcha
- Vertigem = caráter rotatório
###### AFASIAS
- Afasia motora ou verbal (de Broca)
	- Dificuldade de expressar-se pela fala ou escrita
