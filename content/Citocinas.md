...
* Produzido pelos monócitos ativados 
* Envolvido com a [[Sepses]]
>[!important] O TNF é um mediador da resposta inflamatória aguda a bactérias e outros microrganismos infecciosos.
...
alfa: ação sistêmica. 
#### Interleucina - 1 = TNF-alfa
>[!important] A IL-1 também é um mediador da resposta inflamatória aguda e exerce muitas ações similares às do TNF.
### Interleucina - 6 
Estimula a imunidade adquirida, estimulando os linfócitos B. 
>[!important] A IL-6 é outra importante citocina nas respostas inflamatórias agudas, com efeitos locais e sistêmicos. Induz a síntese de reagentes de fase aguda pelo fígado, estimula a produção de neutrófilos na medula óssea e promove a diferenciação de células T auxiliares produtoras de IL-17.
### Quimiocina 
Recrutamento de leucócitos. 
## Interleucina-12 
* Ponte entre a imunidade inata e adquirida. 
	* Estimula a diferenciação dos TCD4. 
	* Estimula a resposta celular NK e CD8. 
* Produzida pelas APC's. 
>[!important] A IL-12 é secretada por DCs e macrófagos e estimula a produção de IFN γ por ILC1s, células NK e células T; intensifica a citotoxicidade mediada pela célula NK e pelo CTL; e promove diferenciação de células Th1.

## Interferon tipo I (alfa e beta)
Interferem na ação dos vírus. 
>[!important] Os interferons do tipo I incluem o interferon-α interferon-β, cuja principal função é prevenir a replicação viral nas células.

## Interferon do tipo II (gama)
* Ativação de macrófagos; 
* Produzido pelos Linfócitos T e NK. 
>[!important] O interferon do tipo II, também denominado interferon-γ, ativa macrófagos e vários outros tipos celulares.

![[Pasted image 20231002143607.png]]
## Interleucina-2 
* Proliferação e sobrevida dos linfócitos. 
>[!important] A interleucina-2 (IL-2) é um fator de crescimento, sobrevivência e diferenciação para os linfócitos T, que desempenha um papel essencial na proliferação de células T estimuladas pelo antígeno e na manutenção de células T reguladoras funcionais.
>A IL-2 é produzida principalmente pelos linfócitos T CD4+ logo após o  reconhecimento do antígeno e dos coestimuladores.
## Interleucina-4
* Estimula a diferenciação de TCD4+ em TCD4+ (Th2)
* Produzida pelas TCD4+. 
